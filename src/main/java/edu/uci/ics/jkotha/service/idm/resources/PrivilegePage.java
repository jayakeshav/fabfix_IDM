...
public class PrivilegePage {
    ...
    public Response privilege(String jsonText, @Context HttpHeaders headers) {
        ...
        try {
            ...
            return Response.status(Response.Status.UNAUTHORIZED).header("transactionID", transactionId).entity(responseModel).build();
