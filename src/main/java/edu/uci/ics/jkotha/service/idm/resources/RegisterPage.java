...
public class RegisterPage {
    ...
    public Response register(String jsonText, @Context HttpHeaders headers) {
        ...
        try {
            ...
            if (!FunctionsRequired.isValidEmail(email)) {
                ...
                return Response.status(Response.Status.BAD_REQUEST).entity(responseModel).header("transactionID", transactionId).build();
            }
                ...
                return Response.status(Response.Status.OK).entity(responseModel).header("transactionID", transactionId).build();
            }
